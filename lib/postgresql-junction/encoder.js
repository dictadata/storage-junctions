...
var stringBreakpoints = Object.assign({}, types.stringBreakpoints);
...
var storageField = exports.storageField = function (column) {
  ...
  let field = {
    ...
    keyOrdinal: column.Key || false,  // TBD
    ...
    switch (field.type) {
      ...
      case "text":
        if (field.size < 0 || field.size > stringBreakpoints.text)
          ...
          mysqlType = "VARCHAR(" + (field.size > 0 ? field.size : stringBreakpoints.text) + ")";
        break;
      case "date":
