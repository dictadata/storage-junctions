  ...
  async _read(size) {
    ...
    try {
      let axiosOptions = {
        ...
        headers: Object.assign({'Accept': 'application/json', 'User-Agent': '@dictadata.org/storage-node'}, this._junction._options.headers),
        auth: this._junction._options.auth || {},
        params: this._junction._options.params || {},
        timeout: this._junction._options.timeout || 10000
      };

      let url = this._junction._options.url || this._engram.smt.schema || '/';
