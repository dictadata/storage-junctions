  ...
  async retrieve(options = null) {
    ...
    try {
      let axiosOptions = {
        ...
        headers: Object.assign({ 'Accept': 'application/json', 'User-Agent': '@dictadata.org/storage-node' }, options.headers),
        auth: options.auth || {},
        params: options.pattern.match || options.params || {},
        timeout: options.timeout || 10000
      };

      let url = options.url || this._engram.smt.schema || '/';
