  ...
  async retrieve(pattern) {
    ...
    try {
      let axiosOptions = {
        ...
        headers: Object.assign({ 'Accept': 'application/json', 'User-Agent': '@dictadata.org/storage-node' }, this.options.headers),
      ...
      let constructs = [];
      encoder.parseData(response.data, this.options.reader, (construct) => {
