...
module.exports = class Codify extends Transform {
  ...
  constructor(storageJunction, options = null) {
    ...
    this._engram = this._junction._engram;
  }
  ...
  _transform(construct, encoding, callback) {
    ...
    try {
      ...
      for (let [name, value] of Object.entries(construct)) {
        ...
        var field = this._engram.encoding.fields[name] || this._engram.encoding.add(new Field(name));
  ...
  _flush(callback) {
    ...
    this.push(this._engram.encoding.fields);
    callback();
  }
