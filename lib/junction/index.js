...
const FieldsTransform = require("../transforms/fields");
const ConsolidateTransform = require("../transforms/consolidate");
...
module.exports = exports = class StorageJunction {
  ...
  getFieldsTransform(options) {
    options = Object.assign({}, this.options.transform, options);
    return new FieldsTransform(this, options);
  }

  // may need to be overriden, generic consolidation functions on JSON object properties
  // A junction interfacing to a database or other data server should
  // be able to push this down to the server instead of transfering raw data.
  getConsolidateTransform(options) {
    options = Object.assign({}, this.options.transform, options);
    return new ConsolidateTransform(this, options);
  }
  ...
  /**
   * Scan the locus for schema such as filenames or table names.
