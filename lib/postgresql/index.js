...
module.exports = class PostgreSQLJunction extends StorageJunction {
  ...
  async putEncoding(encoding) {
    ...
    try {
      ...
      let sql = "SHOW FULL TABLES LIKE '" + this._engram.smt.schema + "';";
  ...
  async recall(pattern=null) {
    ...
    try {
      ...
      let sql = "SELECT * FROM " + this._engram.smt.schema + encoder.sqlWhereFromKey(this._engram, pattern);
  ...
  async dull(pattern=null) {
    ...
    try {
      ...
      if (this._engram.keyof === 'list' || this._engram.keyof === 'all') {
        ...
        let sql = "DELETE FROM " + this._engram.smt.schema + encoder.sqlWhereFromKey(this._engram, pattern);
