...
module.exports = class JsonJunction extends StorageJunction {
  ...
  async getEncoding() {
    ...
    try {
      if (!this._engram.defined) {
        ...
        let reader = this.getReadStream(Object.assign({max_read: this._options.max_read || 100}, this._options) );
        let codify = this.getCodifyWriter();
  ...
  async scan(options=null) {
    ...
    if (!this._options.scan) this._options.scan = {};
    Object.assign(this._options.scan, options);
    return scanner(this);
  }
