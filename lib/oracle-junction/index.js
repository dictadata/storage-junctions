...
const OracleReader = require("./reader");
const OracleWriter = require("./writer");
...
module.exports = exports = class OracleJunction extends StorageJunction {

  /**
   *
   * @param {*} SMT 'oracle|server=address;userName=name;password=xyz;database=dbname;...|table|key' or an Engram object
   * @param {*} options
   */
  constructor(SMT, options) {
    super(SMT, options);
    logger.debug("OracleJunction");

    this._readerClass = OracleReader;
    this._writerClass = OracleWriter;
  ...
  async activate() {
    return new Promise(async (resolve, reject) => {
      logger.debug("OracleJunction.activate");
  ...
  async relax() {
    return new Promise(async (resolve, reject) => {
      logger.debug("OracleJunction.relax");
  ...
  async list(options) {
    return new Promise(async (resolve, reject) => {
      logger.debug('OracleJunction.list');
  ...
  async getEncoding() {
    return new Promise(async (resolve, reject) => {
      logger.debug("OracleJunction.getEncoding");
  ...
  async putEncoding(encoding, overlay=false) {
    return new Promise(async (resolve, reject) => {
      logger.debug("OracleJunction.putEncoding");
  ...
  async recall(pattern) {
    return new Promise(async (resolve, reject) => {
      logger.debug("OracleJunction.recall");
  ...
  async retrieve(pattern) {
    return new Promise(async (resolve, reject) => {
      logger.debug("OracleJunction retrieve");
   ...
   */
  async dull(pattern) {
    logger.debug("OracleJunction dull");
    if (!pattern) pattern = {};
