...
class SplitterJunction extends StorageJunction {
  ...
  async getTractStream(sname) {
    ...
    if (Object.prototype.hasOwnProperty.call(this.split_junctions,sname))
    ...
    if (Object.hasOwnProperty.call(this.split_tract, "transforms")) {
    ...
    if (terminal.encoding) {
      let encoding = terminal.encoding;
