...
module.exports = class ElasticQuery {
   ...
   **/
  insert(document) {
    //console.log("elasticQuery insert");
      ...
      this.client.get(params)
        ...
        .catch(error => {
          if (error.statusCode === 404)
            resolve({result: 'not fouund'});  // not found
          else
            reject(error);
        });
   ...
   **/
  delete(uid) {
    //console.log("elasticQuery delete");
   ...
   **/
  search(query,params={}) {
    //console.log("elasticQuery search");
