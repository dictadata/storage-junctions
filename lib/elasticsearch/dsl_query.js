...
/**
 *
 * @param {*} pattern The match, filter and cues to create an Elasticsearch DSL query
 */
...
function consolidate(dsl, pattern) {
  ...
  dsl["aggregations"] = aggregate(pattern.consolidate, (pattern.cues || {}));
}
