...
/**
 *
 * @param {*} pattern the storage pattern to transform into a Elasticsearch DSL query
 */
exports.transform = function (pattern) {
  console.log("elasticEncoder transformPattern");
  console.log(pattern);
