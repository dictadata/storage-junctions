...
module.exports = class ElasticsearchJunction extends StorageJunction {
  ...
  async getEncoding() {
    ...
    try {
      if (!this._engram.defined) {
        ...
        this._engram.fields = this.typesEncoder.mappingsToFields(mappings);
      }
      return this._engram;
    }
    catch(err) {
  ...
  async putEncoding(encoding) {
    ...
    try {
      ...
      let mappings = this.typesEncoder.fieldsToMappings(encoding.fields);
  ...
  async recall(options = null) {
    ...
    try {
      if (this._engram.keyof === 'uid' || this._engram.keyof === 'key') {
        ...
        let dsl = dslQuery.matchQuery(this._engram.keys, options);
