...
module.exports = exports = class EncoderTransform extends Transform {
  ...
  constructor(options) {
    ...
    if (!Object.hasOwnProperty.call(options, "junction"))
      throw new storage.StorageError({ statusCode: 400 }, "options.junction not defined");

    if (options && Object.prototype.hasOwnProperty.call(storage, options.junction))
      if (Object.hasOwnProperty.call(storage[options.junction], "encoder"))
