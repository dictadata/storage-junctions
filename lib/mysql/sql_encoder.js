 ...
 * function: { consolidate: {"newfield": {"func": "field1"}} }
 * group by: { consolidate: {"newfield": {"field1": {"func", "field2"}}} }
 */
exports.sqlSelectWithPattern = function (engram, pattern) {
  ...
  if (pattern.consolidate) {
    let f = true;
    // find group by fields of consolidate: {"group_by_field": {"func": "field"} }
    for (let [newfld,exp] of Object.entries(pattern.consolidate)) {
