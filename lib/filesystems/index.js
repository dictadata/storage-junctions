...
module.exports = exports = class FileSystem {
  ...
  */
  async createWriteStream(options) {
    ...
    throw new StorageError({ statusCode: 501 }, "FileSystem.createWriteStream method not implemented");
  ...
  async download(options) {
    ...
    throw new StorageError({ statusCode: 501 }, "FileSystem.download method not implemented");
  ...
  async upload(options) {
    ...
    throw new StorageError({ statusCode: 501 }, "FileSystem.upload method not implemented");
