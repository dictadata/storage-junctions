...
module.exports = class ParquetReader extends StorageReader {
  ...
  constructor(storageJunction, options = null) {
    ...
    let parser = null;
    if (this._engram.smt.model === 'Parquets' || this._engram.smt.model === 'Parquetl')
      parser = this.parser = StreamValues.withParser();
    else if (this._engram.smt.model === 'Parqueto')
