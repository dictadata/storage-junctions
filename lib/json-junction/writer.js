...
module.exports = exports = class JsonWriter extends StorageWriter {
  ...
  async _write(construct, encoding, callback) {
    ...
    logger.verbose(JSON.stringify(construct));    
    ...
    try {
      ...
      let data = (this.count === 0) ? "" : this.formation.delimiter;
      ...
      data += JSON.stringify((orderedConstruct.length > 0) ? orderedConstruct : construct);
      if (data.length > 0) {
