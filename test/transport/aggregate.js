...
async function tests() {
  ...
  if (await retrieve({
    ...
    terminal: {
      output: './test/data/output/transport/aggregate_1.json'
    }
  })) return 1;
  ...
  if (await retrieve({
    ...
    terminal: {
      output: './test/data/output/transport/aggregate_2.json'
    }
  })) return 1;
  ...
  if (await retrieve({
    ...
    terminal: {
      output: './test/data/output/transport/aggregate_3.json'
    }
  })) return 1;
