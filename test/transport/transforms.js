...
async function tests() {
  ...
  if (await transfer({
    ...
    terminal: {
      smt: "json|./test/data/output/transport/|transform_0.json|*"
    }
  })) return 1;
  ...
  if (await transfer({
    ...
    terminal: {
      smt: "json|./test/data/output/transport/|transform_1.json|*"
    }
  })) return 1;
  ...
  if (await transfer({
    ...
    terminal: {
      smt: "json|./test/data/output/transport/|transform_2.json|*"
    }
  })) return 1;
