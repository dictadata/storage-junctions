...
async function tests() {
  ...
  if (await store({
    ...
    terminal: {
      output: "./data/output/mysql/store_01.json"
    }
  })) return 1;
  ...
  if (await store({
    ...
    terminal: {
      output: "./data/output/mysql/store_02.json"
    }
  })) return 1;
  ...
  if (await store({
    ...
    terminal: {
      output: "./data/output/mysql/store_03.json"
    }
  })) return 1;
  ...
  if (await store({
    ...
    terminal: {
      output: "./data/output/mysql/store_04.json"
    }
  })) return 1;
