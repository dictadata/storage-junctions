...
async function tests() {
  ...
  if (await transfer({
    ...
    "terminal": {
      "smt": "mysql|host=localhost;database=storage_node|foo_schema_etl2|*",
      "options": {
  ...
  if (await transfer({
    origin: {
      smt: "mysql|host=localhost;database=storage_node|foo_schema_01|*",
      options: {
  ...
  if (await transfer({
    origin: {
      smt: "mysql|host=localhost;database=storage_node|foo_schema_02|*",
      options: {
