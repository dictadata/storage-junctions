...
async function s3Destination() {
  ...
  await transfer({
    ...
    terminal: {
      smt: "csv|S3:dictadata.org/test/output/csv/|output.csv|*",
      options: {
        header: true,
        "s3": {
          "aws_profile": ""
  ...
  await transfer({
    ...
    terminal: {
      smt: "csv|S3:dictadata.org/test/output/csv/|output.csv.gz|*",
      options: {
        header: true,
        "s3": {
          "aws_profile": ""
  ...
  await transfer({
    ...
    terminal: {
      smt: "json|S3:dictadata.org/test/output/json/|output.json|*",
      options: {
        "s3": {
          "aws_profile": ""
        }
  ...
  await transfer({
    ...
    terminal: {
      smt: "json|S3:dictadata.org/test/output/json/|output.json.gz|*",
      options: {
        "s3": {
          "aws_profile": ""
        }
...
async function s3Source() {
  ...
  await transfer({
    ...
    terminal: {
      smt: "csv|./output/s3/|output.csv.gz|*",
      options: {
        header: true
      }
    }
  ...
  await transfer({
    ...
    terminal: {
      smt: "json|./output/s3/|output.json|*"
    }
  });
  ...
  await transfer({
    ...
    terminal: {
      smt: "json|./output/s3/|output.json.gz|*"
    }
  });
