...
async function tests() {
  ...
  await codify({
    ...
    outputFile1: './output/elasticsearch/codify_01.json',
    outputFile2: './output/elasticsearch/codify_02.json'
  });
  ...
  await codify({
    ...
    outputFile1: './output/elasticsearch/codify_11.json',
    outputFile2: './output/elasticsearch/codify_12.json'
  });
  ...
  await codify({
    ...
    outputFile1: './output/elasticsearch/codify_21.json',
    outputFile2: './output/elasticsearch/codify_22.json'
  });
