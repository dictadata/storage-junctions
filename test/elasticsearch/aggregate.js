...
async function tests() {
  ...
  if (await retrieve({
    ...
    terminal: {
      output: './test/_data/output/elasticsearch/aggregate_1.json'
    }
  })) return 1;
  ...
  if (await retrieve({
    ...
    terminal: {
      output: './test/_data/output/elasticsearch/aggregate_2.json'
    }
  })) return 1;
  ...
  if (await retrieve({
    ...
    terminal: {
      output: './test/_data/output/elasticsearch/aggregate_3.json'
    }
  })) return 1;
