...
async function tests() {
  ...
  await codify({
    ...
    outputFile1: './output/mssql_codify_01.json',
    outputFile2: './output/mssql_codify_02.json'
  });
  ...
  await codify({
    ...
    outputFile1: './output/mssql_codify_11.json',
    outputFile2: './output/mssql_codify_12.json'
  });
  ...
  await codify({
    ...
    outputFile1: './output/mssql_codify_21.json',
    outputFile2: './output/mssql_codify_22.json'
  });
