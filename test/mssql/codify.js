...
async function tests() {
  ...
  if (await codify({
    ...
    outputFile1: './test/data/output/mssql/codify_01.json',
    outputFile2: './test/data/output/mssql/codify_02.json'
  })) return 1;
  ...
  if (await codify({
    ...
    outputFile1: './test/data/output/mssql/codify_11.json',
    outputFile2: './test/data/output/mssql/codify_12.json'
  })) return 1;
  ...
  if (await codify({
    ...
    outputFile1: './test/data/output/mssql/codify_21.json',
    outputFile2: './test/data/output/mssql/codify_22.json'
  })) return 1;
