...
logger.info("=== Test: transfer tl_20220_us_state");
...
async function transfer2() {
  ...
  if (await transfer({
    ...
    "terminal": {
      "smt": "elastic|http://localhost:9200/|tl_20220_us_state|*",
      "options": {
...
async function transfer3() {
  ...
  if (await transfer({
    ...
    "terminal": {
      "smt": "json|./data/output/shapefile/|tl_20220_us_state_elastic.json|*"
    }
  })) return 1;
