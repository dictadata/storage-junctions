...
class PostgreSQLJunction extends StorageJunction {
   ...
   */
  async getEncoding() {
    logger.debug("postgresqlJunction get encoding");
    ...
    try {
      ...
      if (err.errno === 1146)  // mysql ER_NO_SUCH_TABLE
        return false;
  ...
  async createSchema(options={}) {
    logger.debug("postgresqlJunction createSchema");
    ...
    try {
      ...
      if (tables.length === 0) {
        ...
        let sql = encoder.sqlCreateTable(this.engram, this.options);
...
//PostgreSQLJunction.encoder = encoder;
//PostgreSQLJunction.sqlEncoder = sqlEncoder;
module.exports = PostgreSQLJunction;
